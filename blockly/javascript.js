...
Blockly.JavaScript['linenotify_sendimg'] = function(block) {
  ...
  // TODO: Assemble JavaScript into code variable.
  var code = "line_notify($.extend({},"+variable_name_+",{message:' ',imageThumbnail:"+value_notify_sendimg_s+",imageFullsize:"+value_notify_sendimg+"}));\n";
  return code;
};
...
Blockly.JavaScript['linebot_set'] = function(block) {
  ...
  var code = "var firebase1ca6d;\n"+
		...
		"firebase1ca6d = new Firebase('https://webduine-teset.firebaseio.com/');\n";
  return code;
};
